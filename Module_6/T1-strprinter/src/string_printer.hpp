 ...
 */
#ifndef AALTO_ELEC_STRING_PRINTER_CLASS
#define AALTO_ELEC_STRING_PRINTER_CLASS
...
class StringPrinter{
    public:
    StringPrinter(std::ostream& os):os_(os){}
    //StringPrinter* Clone() const{}
    
    virtual ~StringPrinter(){}

    virtual StringPrinter& operator()(const std::string& a)=0;
